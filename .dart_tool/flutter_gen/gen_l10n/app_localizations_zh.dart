...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get chichenItzaHistoryInfo1 => '奇琴伊察是玛雅文明的一座强大的地区首都，控制着从尤卡坦州中部到北海岸的一片土地。最早的象形文字在奇琴伊察发现的日期相当于公元832年，而最后一个已知的日期记录在998年的奥萨里奥神庙中。卡斯蒂略金字塔坐落在奇琴伊察北部平台。第一批看到这座金字塔的西班牙人将其命名为“卡斯蒂略” (意为“城堡”)，人们至今仍以这个名字称呼它。';

  @override
  String get chichenItzaHistoryInfo2 => '该市可能是玛雅世界中人口最多样化的地区，这可能是导致该地点建筑风格多样化的一个因素。';

  @override
  String get chichenItzaConstructionInfo1 => '奇琴伊察的建筑结构是由精确凿刻的石灰石块建造而成的，它们之间完美地结合在一起，不需要砂浆。这些石头建筑中许多最初是用红色，绿色，蓝色和紫色绘制的，根据该区域最容易获得的颜料来选择颜料。卡斯蒂略阶梯金字塔高约98英尺(30米)，由9个方形阶梯组成，每个阶梯高约8.4英尺(2.57米)，顶部有一座20英尺(6米)高的神庙。';

  @override
  String get chichenItzaConstructionInfo2 => '这座城市是建立在破碎的地形上的，为了建立主要的建筑群，人为地将其夷为平地，对Castillo金字塔以及相关建筑物的平坦度上进行了最大的努力。这些重要的建筑物通过密集的铺装过道相互连接，称为萨科布。';

  @override
  String get chichenItzaLocationInfo1 => '奇琴伊察位于墨西哥尤卡坦州的东部。它附近有四个可见的自然沉孔，称为 cenotes ，这可能会为奇琴伊察全年提供充足的水源，使其成为定居点的吸引力。';

  @override
  String get chichenItzaLocationInfo2 => '在这些cenote (天然井) 中，“ Cenote Sagrado” 或 \"神圣天然井\" 被用来祭祀珍贵的物品和人类，作为对玛雅雨神Chaac的一种崇拜。';
  ...
  @override
  String get christRedeemerVideoCaption => '“雄伟的救世基督雕像——现代世界七大奇迹——我们在历史中见。” Youtube，由See U in History / Mythology (我们在历史/神话中见）上传。';

  @override
  String get christRedeemerMapCaption => '显示救世基督像位于巴西里约热内卢的地图。';

  @override
  String get christRedeemerHistoryInfo1 => '19世纪50年代中期，为了纪念巴西末代皇帝佩德罗二世的女儿伊莎贝尔公主，人们首次提议在科尔科瓦多山上建一座基督教纪念碑，但该项目未获批准。1889年巴西成为共和国，由于政教分离，提议的雕像被驳回。';

  @override
  String get christRedeemerHistoryInfo2 => '第二次“在山上建立一个雕像”的提议是里约热内卢天主教会在1920年所提出。天主教会组织了一个叫做“纪念像周”（Semana do Monumento）的活动来吸引捐款和收集签名，支持雕像的建造。这个组织的动机是他们在社会中所观察到的“无神论”。基督雕像的设计要求包括：代表基督教的十字架，一座手持地球仪的耶稣基督像，和一个象征世界的基座。';

  @override
  String get christRedeemerConstructionInfo1 => '雕像由艺术家卡洛斯·奥斯瓦尔德和当地工程师海托·达·席尔瓦·科斯卡设计，由法国雕塑家保罗·兰多斯基执行雕塑。1922年，弗兰多斯基委托在巴黎的罗马尼亚雕塑家盖奥赫·莱奥尼达，后者曾在布加勒斯特和意大利的美术学院学习雕塑。';

  @override
  String get christRedeemerConstructionInfo2 => '一组工程师和技师团研究了兰多斯基的设计方案，并决定以钢筋混凝土代替钢材，以便更适合十字架形状的雕像。雕像基座的混凝土来自瑞典的利姆。科斯卡和兰多斯基决定以滑石作为雕像的外层材料，因为它经久耐用，易于使用。';

  @override
  String get christRedeemerLocationInfo1 => '科尔科瓦多，在葡萄牙语中是“驼背”的意思，是巴西里约热内卢中部的一座山。它是一座2329英尺(710米)高的花岗岩山峰，位于Tijuca森林国家公园。';
  ...
  @override
  String get colosseumHistoryInfo2 => '罗马斗兽场在中世纪前期已不再用在娱乐用途。到了6世纪晚期，圆形剧场里建起了一座小教堂，斗兽场也被改建为墓地。在座位下方的拱廊里，无数的拱形空间被改造成了住房和作坊，据记载，直到12世纪仍在出租。';

  @override
  String get colosseumConstructionInfo1 => '罗马斗兽场的建造始于公元72年，在皇帝韦斯巴芗 (公元69-79年) 的统治下，并在他的继任者提图斯 (公元79-81年) 的统治下于公元80年完成。在图密善统治时期 (公元81-96年) 进行了进一步的修改。罗马斗兽场由石灰华(洞石)、凝灰岩 (火山岩) 和砖面混凝土建造而成。它的外墙是用超过350万立方英尺的石灰华石头建造的，这些石头没有用灰浆凝结，而是用300吨的铁夹子固定在一起。';

  @override
  String get colosseumConstructionInfo2 => '罗马斗兽场在历史上不同时期预计可容纳5万至8万名观众，平均观众约为6.5万名。';

  @override
  String get colosseumLocationInfo1 => '在公元64年的罗马大火之后，尼禄皇帝利用大部分被摧毁的地区建造了他的宏伟的Domus Aurea(“黄金屋”)。这座奢华的宫殿给尼禄的继任者带来了极大的尴尬。大约1平方英里的宫殿场地后来被填满了泥土，并盖上了新的建筑。';
  ...
  @override
  String get greatWallHistoryInfo2 => '早在公元前7世纪，就有几道墙被修建，后来中国的第一位皇帝秦始皇 (公元前220-206年) 将它们连接起来。如今，秦长城只留下断断续续的遗迹。后来，边境墙被许多朝代连续重建、维护和加强。';
  ...
  @override
  String get machuPicchuHistoryInfo1 => '马丘比丘是一座建于15世纪的印加帝国城市遗迹，位于秘鲁南部的东科迪勒拉山脉，高耸在海拔2,430米（7,970英尺）的山脊上。马丘比丘建造在两个伟大的印加统治者帕查庫特克·尤潘基(1438-1471) 和图帕克·印卡·尤潘基(1472-1493)时期。';

  @override
  String get machuPicchuHistoryInfo2 => '考古学家一致认为帕恰库特很可能是在赢得一场军事战役之后，下令建造这座皇家庄园作为私人休养地。但这座庄园只使用了80年就被废弃了，可能是因为西班牙人征服了印加帝国的其他地区。';

  @override
  String get machuPicchuConstructionInfo1 => '中心建筑采用了经典的印加建筑风格，抛光的规则形状的干石墙。印加的墙壁有许多稳定的特点:门窗是梯形的，从下到上变窄;角通常是圆形的;内角通常略微向房间内倾斜，外角通常用“L”形的木块连接在一起。';

  @override
  String get machuPicchuConstructionInfo2 => '这种精确的建造方法使马丘比丘的结构能够抵抗地震活动。这个地点本身可能是有意建在断层线上的，这样可以提供更好的排水系统和现成的碎石供应。';

  @override
  String get machuPicchuLocationInfo1 => '马丘比丘位于乌鲁班巴河之上，乌鲁班巴河三面围绕着遗址，悬崖从1480英尺(450米)垂直下降到河流的底部。这座城市的位置是一个军事机密，它的深崖和陡峭的山脉提供了天然的防御。';
  ...
  @override
  String get petraHistoryInfo1 => '佩特拉周边地区早在公元前7000年就有人居住，纳巴泰人可能早在公元前4世纪就定居在他们王国的首都。贸易业务为纳巴泰人带来了可观的收入，佩特拉成为他们财富的焦点。纳巴泰人与他们的敌人不同，他们习惯了生活在贫瘠的沙漠中，并能够利用该地区的山区地形击退攻击。';

  @override
  String get petraHistoryInfo2 => '佩特拉在公元1世纪繁荣发展，当时人口达到顶峰，估计有两万居民。大约在同一时间，它著名的卡兹尼神殿被建造，据信是纳巴泰国王阿雷塔斯四世的陵墓。进入这座城市要穿过一个称为Siq的3/4英里长(1.2公里)的峡谷，直接通往卡兹尼神殿。';

  @override
  String get petraConstructionInfo1 => '佩特拉因其岩石雕刻的建筑和水管系统而闻名，被称为“红玫瑰城”。佩特拉也因其希腊风格的建筑而闻名。这种影响可以在佩特拉的许多建筑中看到，并反映了纳巴泰人与之交易的多元文化。';

  @override
  String get petraConstructionInfo2 => '宝库的正面是一个破碎的三角楣，里面有一个中央圆顶，两个方尖碑在顶部似乎形成了佩特拉的岩石。在宝库底部附近，我们看到了双胞胎希腊神波鲁克斯和卡斯特，在旅途中保护旅行者。在靠近宝库顶部的地方，可以看到两个胜利雕像分别站在梭罗上的女性雕像的两侧。这个女性形象被认为是伊西斯-堤喀，伊西斯是埃及女神，而堤喀是希腊的好运女神。';

  @override
  String get petraLocationInfo1 => '佩特拉位于约旦南部。它毗邻Jabal Al-Madbah山，在一个被山脉包围的盆地中，形成了从死海到亚喀巴湾的阿拉伯山谷的东侧。';

  @override
  String get petraLocationInfo2 => '佩特拉周边地区早在公元前7000年就有人居住，纳巴泰人可能早在公元前4世纪就定居在他们王国的首都。考古工作只发现了纳巴泰人始于公元前2世纪的证据，那时佩特拉已经成为他们的首都。纳巴泰人是游牧的阿拉伯人，他们把佩特拉建成了一个主要的区域贸易中心，在靠近香贸易路线的地方投资。';
  ...
  @override
  String get pyramidsGizaHistoryInfo1 => '吉萨金字塔群，又名吉萨墓地，位于埃及大开罗地区的吉萨高原，包括吉萨大金字塔、卡夫拉金字塔、孟卡拉金字塔，以及与其相关的金字塔群和吉萨狮身人面像。这些建筑都建于埃及古王国第四王朝时期，即公元前2600年至公元前2500年之间。';

  @override
  String get pyramidsGizaHistoryInfo2 => '吉萨金字塔和其他金字塔被认为是用来存放古埃及法老遗体的。埃及人相信，法老的灵魂中有一部分被称为他的ka，在他死后与他的尸体一起存在。为了让前法老履行他作为亡灵之王的新职责，妥善保管遗体是必要的。';

  @override
  String get pyramidsGizaConstructionInfo1 => '大多数理论认为，金字塔是通过从采石场搬运巨大的石头，然后拖吊到合适的地方而建成的。在建造金字塔的过程中，建筑师可能随着时间的推移而发展了他们的技术。他们没有选择沙子作为地基，而是选择了一块基岩相对平坦的地方，这样可以提供一个稳定的地基。在仔细勘察了遗址并铺好了第一层石头之后，建筑者们用水平的方式建造金字塔，一层接着一层。';

  @override
  String get pyramidsGizaConstructionInfo2 => '大金字塔内部的大部分石头似乎都是在建筑工地的南面开采的。金字塔光滑的外表是由尼罗河上开采的优质白色石灰石制成的。为了确保金字塔保持对称，外部外壳的石头都必须在高度和宽度相等。工人们可能已经在所有的石块上做了标记，以表明金字塔墙壁的角度，并仔细地修整表面，以便将石块拼在一起。在施工过程中，石头的外表面是光滑的石灰石;随着时间的推移，多余的石头已被侵蚀。';
  ...
  @override
  String get tajMahalHistoryInfo1 => '泰姬陵是位于印度北方邦阿格拉市亚穆纳河右岸的一座用白色大理石建造的陵墓。它是莫卧儿王朝皇帝沙贾汗为了纪念他最喜爱的妻子—已故皇后姬蔓·芭奴而兴建的陵墓，沙贾汗本人身故后亦合葬于此。';

  @override
  String get tajMahalHistoryInfo2 => '这座陵墓是一个42英亩(17公顷)的建筑群的中心，其中包括两座清真寺建筑(对称地安置在陵墓的两侧)，一个招待所，坐落在三面城墙围成的花园中。';

  @override
  String get tajMahalConstructionInfo1 => '泰姬陵的建造材料来自印度和亚洲各地。据信有超过1000头大象被用来运输建筑材料。半透明的白色大理石来自拉贾斯坦邦，碧玉来自旁遮普，玉石和水晶来自中国。绿松石来自西藏，青金石来自阿富汗，而蓝宝石则来自斯里兰卡。这座建筑的白色大理石上总共镶嵌了28种宝石和半宝石。';

  @override
  String get tajMahalConstructionInfo2 => '挖掘出大约三英亩的土地，填满泥土以减少渗漏，并将其平整在河岸上方160英尺的地方。在墓区，人们挖井，填满石头和碎石，形成坟墓的基座。基座和坟墓花了大约12年的时间才完成。该建筑群的其余部分又花了10年时间完成。';
