...
class DiagonalTextPageIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StaticTextScale(
      child: Padding(
        padding: EdgeInsets.symmetric(horizontal: textStyle.fontSize! * .4)
              ...
              child: SizedBox(
                ...
                child: Opacity(
                  ...
                  child: Text(
                    '0$total',
                    style:
                        textStyle, //.copyWith(shadows: $styles.shadows.textStrong),
                  ),
                ),
              ),
            ),
  ...
  Path getClip(Size size) {
    ...
    if (leftSide) {
      return Path()
        ...
        ..addRect(
            Rect.fromLTRB(-size.width * .5, -size.height * .5, size.width, 0));
    }
    return Path()
      ...
      ..lineTo(size.width + lineGap, 0)
      ..addRect(
          Rect.fromLTRB(size.width, 0, size.width * 1.5, size.height * 1.5));
  }
