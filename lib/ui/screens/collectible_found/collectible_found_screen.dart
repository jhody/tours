...
import 'package:tours/logic/data/collectible_data.dart';
import 'package:tours/ui/common/app_backdrop.dart';
import 'package:tours/ui/common/centered_box.dart';
import 'package:tours/ui/common/controls/app_header.dart';
import 'package:tours/ui/common/pop_navigator_underlay.dart';
...
class CollectibleFoundScreen extends StatelessWidget {
  ...
  const CollectibleFoundScreen(
      {required this.collectible, required this.imageProvider, super.key});
  ...
  Widget _buildIntro(BuildContext context) {
    ...
    return Stack(children: [
      Animate().custom(
          duration: t * 5,
          builder: (context, ratio, _) => _buildGradient(context, ratio, 0)),
        ...
        child: CenteredBox(
          ...
          child: Column(
            children: [
              ...
              _buildTitle(context, collectible.title, $styles.text.h2,
                  $styles.colors.offWhite, t * 1.5),
              Gap($styles.insets.xs),
              _buildTitle(context, collectible.subtitle.toUpperCase(),
                  $styles.text.title2, $styles.colors.accent1, t * 2),
              Spacer(),
              Gap($styles.insets.lg),
    ...
    return AppImage(image: imageProvider, scale: 1.0)
        ...
        .custom(
          ...
          builder: (_, ratio, child) => Container(
            ...
            decoration:
                BoxDecoration(color: $styles.colors.offWhite, boxShadow: [
              BoxShadow(
  ...
  Widget _buildTitle(BuildContext context, String text, TextStyle style,
      Color color, Duration delay) {
    Duration t = $styles.times.fast;
