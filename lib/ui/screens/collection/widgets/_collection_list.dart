...
class _CollectionListState extends State<_CollectionList> with GetItStateMixin {
  ...
  // Mantenga la posición de desplazamiento al cambiar entre orientación vertical y horizontal.
  // Multiplica o divide la posición de desplazamiento actual por la proporción de las extensiones de la tarjeta vertical y horizontal.
  ...
  Widget build(BuildContext context) {
    ...
    // Cree una lista de colecciones compartida por diseños hz y vt
    ...
    // La vista de desplazamiento se adapta para desplazarse vertical u horizontalmente
